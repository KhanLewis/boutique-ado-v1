...
def add_to_bag(request, item_id):
    """ add a qauntity of the specific product to the shopping bag """
    ...
    if size:
        if item_id in list(bag.keys()):
            if size in bag[item_id]['item_by_size'].keys():
                ...
                messages.success(request, f'Updated size {size.upper()} {product.name} quantity to your {bag[item_id]["item_by_size"][size]}')
